...
class MyHookSubscriber_Version extends Zikula_AbstractVersion
{
    ...
    {
         $bundle = new Zikula_HookManager_SubscriberBundle($this->name, 'modulehook_area.myhooksubscriber.mhs', 'ui', __('MyHookSubscriber Display Hooks'));
         ...
         $bundle = new Zikula_HookManager_SubscriberBundle($this->name, 'modulehook_area.myhooksubscriber.mhsfilter', 'filter', __('MyHookSubscriber Filter Hooks'));
